...
chapter_1.dialogos_comuns = {
    ...
    { nome = "Kenji", texto = "Mais uma vez saindo com os mesmos caras idiotas.", som="cute-laugh"},
    { nome = "Kenji", texto = "Cadê as gatinhas?"},
    { nome = "Takashi", texto = "E aí, Kenji, pensando em mulher de novo?"},
    { nome = "Kenji", texto = "Claro, e você não?", som="pedro"},
    ...
    { nome = "Takashi", texto = "Eu não tiraria os olhos das coxas dela nem por um minuto.", som = "oh-my-gah.mp3"},
    ...
    { nome = "Takashi", texto = "Mas me fala aí, quem você gostaria que estivesse sentada aqui no meu lugar agora?", som="cute-giggle" },
...
chapter_1.interacoes_por_rota = {
    ...
    -- Rota 4: Iroha
    [4] = {
        [31] = { -- Interação sobre cinetose (SÓ na Rota 4: Iroha)
